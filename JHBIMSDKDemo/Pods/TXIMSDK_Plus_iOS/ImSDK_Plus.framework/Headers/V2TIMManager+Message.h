...
/**
 * 5.16 发送消息已读回执 （6.1 及其以上版本支持）
 *
 * @note 请注意：
 * - 该接口暂时只支持 Group 消息。
 * - messageList 里的消息必须在同一个 Group 会话中。
...
/**
 * 5.18 获取群消息已读群成员列表（6.1 及其以上版本支持）
 * @param message 群消息
...
/// 只有华为和谷歌手机支持设置铃音提示，小米铃音设置请您参照：https://dev.mi.com/console/doc/detail?pId=1278#_3_0
